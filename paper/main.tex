...
One model family and three scales, so whether the transfer result holds across families is untested
and is the first thing we would add. Judges are single-token log-probability readouts, which is what
